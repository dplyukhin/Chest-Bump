...
var url = require('url');
//HTTP browser request modules
var fs = require('fs');
var connect = require('connect');
var app = connect().use(connect.static('browser')).listen(process.env.PORT || 8000);
...
//Return the page to browser
/*fs.readFile('./browser/index.html', function (err, html) {
    if (err) {
        throw err;
    }
...
console.log('Started static html server on port 8000');
